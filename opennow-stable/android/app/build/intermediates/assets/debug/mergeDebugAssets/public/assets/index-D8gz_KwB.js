...
function buildSessionRequestBody(input) {
  ...
  const requestedZoneAddress = input.requestedZoneAddress?.trim() || void 0;
...
function extractQueueEta(payload) {
  const seat = payload.session.seatSetupInfo;
...
function buildCapacitorApi() {
  ...
  return {
    ...
    pingRegions: (urls) => callNativePlugin("pingRegions", { urls })
  };
}
let _api = null;
...
const LayoutGrid = createLucideIcon("layout-grid", __iconNode$j);
/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Minimize = createLucideIcon("minimize", __iconNode$a);
/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function Navbar({
  ...
  const navItems = [
    { id: "home", label: "Catalog", icon: LayoutGrid },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "navbar", children: [
    activeSession && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        title: activeSession.serverIp ? activeSessionTitle ? `Resume: ${activeSessionTitle}` : "Resume active session" : "Active session found (missing server address)",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "navbar-tabs", children: navItems.map((item) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 22, strokeWidth: isActive ? 2.2 : 1.8 }),
...
function LibraryPage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "home-page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "home-toolbar", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "home-count", children: [
        games.length,
        " game",
        games.length !== 1 ? "s" : ""
      ] })
    ...
    ] }) : games.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "home-empty-state", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Gamepad2, { className: "home-empty-icon", size: 44 }),
    ...
    ] }) : filteredGames.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "home-empty-state", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "home-empty-icon", size: 44 }),
    ...
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "game-grid", children: filteredGames.map((game, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      GameCard,
      {
        game,
        isSelected: game.id === selectedGameId,
...
function SettingsPage({ settings, regions, onSettingChange, user, subscription, onLogout }) {
  ...
  const [pingMs, setPingMs] = reactExports.useState({});
  const [pinging, setPinging] = reactExports.useState(false);
  const runPing = reactExports.useCallback(async () => {
    ...
    try {
      ...
      for (const [url, val_] of Object.entries(result.results)) {
        parsed[url] = typeof val_ === "number" ? val_ : parseInt(val_, 10);
      }
      setPingMs(parsed);
    } catch (err) {
  ...
  const pingAutoRanRef = reactExports.useRef(false);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-page", children: [
    user && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-profile", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-profile-avatar", children: user.avatarUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: user.avatarUrl, alt: user.displayName, className: "settings-profile-img" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-profile-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(User, { size: 28 }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-profile-info", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "settings-profile-name", children: user.displayName }),
        user.email && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "settings-profile-email", children: user.email }),
        tierInfo && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `settings-profile-tier ${tierInfo.className}`, children: tierInfo.label }),
        subscription && !subscription.isUnlimited && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "settings-profile-time", children: [
          subscription.remainingHours.toFixed(1),
          "h remaining"
        ] }),
        subscription?.isUnlimited && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "settings-profile-time", children: "Unlimited" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "settings-profile-logout", onClick: onLogout, title: "Sign out", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-sections", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "settings-section", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-section-header", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Region" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              type: "button",
              children: [
                pinging ? /* @__PURE__ */ jsxRuntimeExports.jsx(Loader, { size: 13, className: "settings-loading-icon" }) : null,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-rows", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "region-selector", children: [
          ...
          regionDropdownOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "region-dropdown", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "region-dropdown-list", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `region-ping ${ping === void 0 || ping === null ? "region-ping--measuring" : ping === -1 ? "region-ping--unreachable" : ping < 80 ? "region-ping--good" : ping < 150 ? "region-ping--ok" : "region-ping--bad"}`, children: ping === void 0 || ping === null ? "..." : ping === -1 ? "--" : `${ping}ms` }),
...
function getStatusMessage(status, isError = false) {
  if (isError) {
...
function StreamView({
  ...
  const [statsCollapsed, setStatsCollapsed] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sv", children: [
    ...
    showStats && !isConnecting && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `sv-stats${statsCollapsed ? " sv-stats--collapsed" : ""}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sv-stats-toggle-rtt", children: stats.rttMs > 0 ? `${stats.rttMs.toFixed(0)}ms` : "--" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `sv-stats-toggle-arrow${statsCollapsed ? " is-collapsed" : ""}`, children: "❮" })
          ]
        }
      ),
      !statsCollapsed && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
...
function App() {
  ...
  const [queueEta, setQueueEta] = reactExports.useState();
  ...
  const handlePlayGame = reactExports.useCallback(async (game) => {
    ...
    try {
      ...
      const sessionStreamingBaseUrl = settings.region ? settings.region.startsWith("http") ? settings.region.replace(/\/$/, "") : `https://${settings.region}` : effectiveStreamingBaseUrl;
      ...
      const newSession = await getPlatformApi().createSession({
        ...
        requestedZoneAddress: settings.region ? (() => {
          try {
            return new URL(settings.region).hostname || settings.region;
          } catch {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      streamStatus !== "streaming" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        StreamLoading,
        {
          ...
          queuePosition,
          estimatedWait: queueEta !== void 0 ? queueEta >= 60 ? `${Math.ceil(queueEta / 60)}m` : `${queueEta}s` : void 0,
          error: launchError ? {
